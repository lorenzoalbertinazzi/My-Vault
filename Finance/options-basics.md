...
### June 10, 2026 Addition: The 0DTE Phenomenon — Mechanics, Market Impact, and the Volatility Regime Shift

**Zero-days-to-expiry (0DTE) options: the structural shift in options markets.** The most consequential development in equity options markets since the introduction of the volatility index (VIX) in 1993 has been the explosive growth of zero-days-to-expiry (0DTE) S&P 500 options. In 2016, daily expiry options did not exist for the S&P 500 — contracts expired on monthly cycles. CBOE introduced daily expiry options for the SPX in May 2022. By Q1 2026, 0DTE SPX options represent **over 55% of total S&P 500 options volume by contract count** — a transformation that has fundamentally altered the intraday volatility structure of the equity market.

**The mechanics of the 0DTE impact on spot prices.** When a retail investor buys a 0DTE call option (betting the market will rise intraday), a market maker sells the call and hedges by buying shares proportional to the option's delta. As the spot price rises and the option approaches the money, delta increases rapidly (gamma effect) — the market maker must buy more shares to remain delta-neutral, creating a self-reinforcing price impulse. This **gamma-driven price amplification** operates identically in both directions: 0DTE call buying creates mechanical buying of the index; 0DTE put buying creates mechanical selling. The result: intraday price volatility has increased measurably. Leland O'Brien Rubinstein's (LOR) concept of "dynamic hedging amplification" — originally developed in the context of 1987 portfolio insurance — is reproduced on a daily basis by the 0DTE options market.

**The VIX paradox: low VIX despite elevated 0DTE activity.** A persistent anomaly in 2025–2026: the CBOE VIX — which measures implied volatility of 30-day SPX options — has remained relatively contained (typically 15–20) despite the elevated intraday volatility created by 0DTE flows. The explanation: the VIX specifically measures *expected volatility over the next 30 days* using options with 23–37 days to expiry. The 0DTE options market creates intraday volatility that resolves within hours — it does not affect 30-day vol expectations. This creates a measurement gap: the VIX understates the realized intraday volatility that traders actually experience, while appearing deceptively calm at the monthly horizon. CBOE has responded by creating the **VIX1D** (1-day VIX) — a measure of 24-hour implied volatility using 0DTE options — which shows significantly higher and more volatile readings than the traditional VIX.
