...
### Prospect Theory and the Behavioral Gap in Portfolio Construction

The [[Psychology/prospect-theory-and-decision-making]] framework offers the most precise psychological account of why investors deviate from mean-variance efficient portfolios — and why those deviations are systematic and predictable rather than random. Kahneman and Tversky's value function, defined over gains and losses relative to a reference point rather than absolute wealth levels, generates a specific set of portfolio pathologies.

**The equity premium puzzle resolved by myopic loss aversion**: Shlomo Benartzi and Richard Thaler (1995) demonstrated that the historical equity risk premium (~5.5% annually) — which cannot be explained by any plausible level of risk aversion in standard utility theory — emerges naturally from Prospect Theory combined with mental accounting over short evaluation horizons. An investor who evaluates portfolio performance annually will observe negative returns in roughly 30% of calendar years. With loss aversion coefficient λ ≈ 2.25, the psychological cost of those negative years is 2.25× the benefit of equivalent positive years. The Prospect Theory investor requires a substantial premium to accept equities over bonds — exactly the observed equity risk premium — when evaluation frequency is approximately annual. This "myopic loss aversion" model makes a testable prediction: investors who evaluate portfolios less frequently (quarterly vs. monthly) should hold more equities. The prediction has been confirmed empirically. The portfolio design implication is stark: reducing evaluation frequency — for instance, by configuring 401(k) accounts to show only annualized returns rather than daily fluctuations — increases willingness to hold equities without changing any rational assessment of risk, purely by reducing the frequency of loss domain experiences.

**Reference-dependent risk taking and the rebalancing problem**: The loss aversion coefficient creates a specific asymmetry in rebalancing behavior that has profound portfolio consequences. When equities have risen and bonds have underperformed (standard equity bull market dynamics), rebalancing requires *selling* equities (in the gain domain: the concave value function makes certainty attractive, facilitating sales) and *buying* bonds (adding a currently underperforming asset, which feels like chasing a loser). The first is psychologically easy under Prospect Theory; the second is psychologically difficult — it requires buying an asset in the loss domain of recent performance where the value function's convexity makes additional purchases uncomfortable. This asymmetry means investors systematically delay buying the underperforming asset during rebalancing. Conversely, in a bear market, selling equities (crystallizing losses from the pain-maximizing reference point) is difficult while buying bonds (adding to a "winner" relative to equities) is easy — but by this point, the rebalancing should have already been partially executed. The net effect is systematic drift toward the most-recently-outperforming asset class and delayed rebalancing at inflection points — exactly the pattern that amplifies equity losses during bear markets and underweights the subsequent recovery. Automated, rules-based rebalancing is the prospect-theory-aware response: it removes the reference-point-dependent decision point entirely.

**Narrow framing and correlated portfolio risk**: Prospect Theory's "narrow framing" — evaluating each position independently rather than in portfolio context — is one of the most practically damaging portfolio construction errors. An investor who evaluates each position's gain/loss relative to its purchase price applies the value function position-by-position rather than to the total portfolio. This means they can hold a deeply loss-making position because the prospect-theory pain of realizing the loss exceeds the portfolio diversification benefit of exiting it, while simultaneously holding excess cash because no single "available" investment offers a compelling prospective gain after accounting for loss aversion. The result is a portfolio that is simultaneously over-concentrated in loss-making positions (held via loss aversion) and under-deployed in the risky asset class (because the certainty of "safety" in cash has elevated value under the gain-domain concavity). Markowitz's insight — that the relevant unit of analysis is the portfolio, not individual positions — requires overriding the narrow framing that Prospect Theory naturally induces, which is why position-sizing and portfolio-level risk management frameworks (like risk parity) are essential debiasing tools.
...
- [[Psychology/prospect-theory-and-decision-making]] — Loss aversion as the reason investors deviate from optimal risk-taking; reference-point-dependent portfolio evaluation explaining the equity premium puzzle and myopic loss aversion
...
### Saturday Cross-Disciplinary Synthesis: Portfolio Theory as Applied Systems Science

**Connection to Thermodynamics — Entropy, Diversification, and Portfolio Disorder:**  
Thermodynamic entropy (the measure of disorder or the number of microstates consistent with a macrostate) has a direct financial analog in portfolio diversification. Maximum entropy portfolios (Meucci, 2009) allocate assets to maximize the entropy of the portfolio's risk contributions — spreading risk as evenly as possible across assets, analogous to maximizing physical entropy in a closed system. This approach is theoretically motivated by the principle of maximum entropy (Jaynes, 1957): given constraints (expected return, total volatility), the distribution that makes fewest additional assumptions about asset behavior is the maximum entropy distribution. In practice, maximum entropy portfolios are more stable out-of-sample than mean-variance optimized portfolios precisely because they make fewer distributional assumptions — trading optimality-given-model for robustness-to-model-error. The thermodynamic connection is not merely metaphorical: portfolio entropy and physical entropy share the same mathematical formulation (Boltzmann entropy), with asset weights replacing probability distributions over microstates.

**Connection to Epidemiology — Infection Dynamics and Correlation Contagion:**  
Portfolio correlation matrices are not static parameters but dynamic processes that exhibit contagion dynamics analogous to epidemiological spread. During crises, correlations spike — "correlation breakdown" in the crisis sense means that diversification fails when it is needed most, because crisis cascades synchronize previously uncorrelated asset movements. The mechanism is analogous to epidemiological super-spreader events: in normal times, financial "infections" (margin calls, stop-loss triggers, forced selling) spread slowly through the network; during crises, highly connected nodes (prime brokers, major clearinghouses) become super-spreaders, synchronizing behavior across the entire network simultaneously. The practical implication: static historical correlation matrices dramatically underestimate crisis-period portfolio risk, motivating dynamic conditional correlation models (Engle, 2002) and stress-testing frameworks that explicitly model crisis-state correlation regimes.

**Connection to Cognitive Science — The Limits of Human Portfolio Intuition:**  
Research in cognitive science reveals that human intuition is systematically misleading for portfolio construction tasks. The "1/N heuristic" (Benartzi & Thaler, 2001) documents that defined contribution plan participants spread their contributions approximately equally across all available funds, regardless of the funds' risk-return profiles or correlation structures — a behavior that violates every principle of portfolio theory but is cognitively compelling due to its simplicity. Taleb (2007) argues that human cognition is fundamentally adapted for a "Mediocristan" world (where outcomes follow normal distributions) and is systematically misled in "Extremistan" (where outcomes follow power laws with fat tails) — the domain in which financial markets actually operate. The implication for portfolio management: the cognitive effort required to implement even basic portfolio theory (understanding correlation, rebalancing, tilts) exceeds what most investors reliably invest in practice, creating a systematic wedge between theoretically optimal portfolios and practically held portfolios.
...
### June 10, 2026 Addition: Regime-Conditional Correlations and the Breakdown of the 60/40 Portfolio in Stagflation

**The 60/40 portfolio's historical rationale.** The traditional 60% equity / 40% bond portfolio has been the dominant institutional and retail asset allocation framework for 40 years. Its risk management logic rests entirely on the negative equity-bond correlation: when equity markets sell off (risk-off), investors typically rotate into government bonds (flight to quality), causing bond prices to rise and cushioning portfolio drawdowns. From 1980 to 2020, the 10-year rolling equity-bond correlation averaged approximately −0.25 in the US, making the 60/40 a genuine diversification vehicle.

**The 2022 correlation regime shift — and its persistence.** In 2022, the equity-bond correlation turned sharply positive (reached +0.60 in Q3 2022) as inflationary monetary tightening simultaneously depressed bond prices (yields rising) and equity prices (discount rate rising). The 60/40 portfolio returned −16.1% in 2022 — the worst calendar year since 1937. A question central to 2026 portfolio construction is whether this correlation sign flip is a temporary anomaly or a regime change: in the current environment of Hormuz-driven energy inflation (+2 percentage points of CPI) and sticky services inflation, the equity-bond correlation has reverted to slightly positive territory (+0.15 in 2026), suggesting the diversification benefit of bonds remains impaired.

**The Antti Ilmanen correlation framework.** Antti Ilmanen (AQR Capital, *Investing Amid Low Expected Returns*, 2022) developed a macroeconomic framework for predicting the equity-bond correlation sign. The key determinant: whether growth risk or inflation risk is the dominant macro uncertainty. In a **growth-dominated** regime (low inflation, business cycle uncertainty), growth shocks simultaneously reduce equity valuations and increase bond demand → negative equity-bond correlation. In an **inflation-dominated** regime (high/unstable inflation), inflation shocks simultaneously reduce equity valuations (higher discount rates) and reduce bond valuations (nominal yields rise) → positive equity-bond correlation. The current 2026 environment — with PCE inflation at 2.8% and energy-shock risk elevated — places the US in a transitional zone between these regimes, explaining the mildly positive but unstable correlation.
