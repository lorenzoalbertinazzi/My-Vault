...
### Saturday Cross-Disciplinary Synthesis: Computer Vision as Perception Engineering

**Connection to Neuroscience — Visual Cortex and CNN Convergence:**
The convergence between biological visual processing and CNN architecture is one of the most striking examples of cross-disciplinary validation in science. Hubel and Wiesel's Nobel Prize-winning discovery (1959–1968) of simple and complex cells in the visual cortex — oriented edge detectors that hierarchically compose into object representations — was the biological blueprint that Yann LeCun's LeNet (1989) formalized computationally. The biological-computational parallel is not merely structural but functional: adversarial examples (imperceptible image perturbations that fool CNNs) also fool humans under certain conditions; the categories that CNNs find most difficult to classify (fine-grained distinctions within species) are also most difficult for humans; and CNN representations trained on large datasets show high representational similarity to primate V4/IT cortex representations (measured by representational similarity analysis, Khaligh-Razavi & Kriegeskorte, 2014).

**Connection to Privacy Law — Computer Vision and Surveillance Ethics:**
Computer vision's most consequential deployment is in surveillance systems: facial recognition (deployed in China's "sharp eyes" system at city scale, airports and border crossings globally), license plate recognition (ubiquitous in law enforcement), and behavioral recognition (gait analysis, crowd density monitoring). The legal and ethical questions are genuinely novel: traditional privacy law presupposed that public space was not continuously monitored with identity-matching capability; computer vision at scale eliminates that presumption. The EU's AI Act prohibits "real-time remote biometric identification" in public spaces in law enforcement contexts (with narrow exceptions) — one of the strongest global restrictions. The US has no federal framework; San Francisco, Boston, and other cities have banned municipal use while states like Illinois and Texas have biometric data privacy laws. The 2026 geopolitical dimension: China's surveillance infrastructure exports (Huawei, Hikvision, Dahua) are providing authoritarian governments globally with computer vision surveillance systems, creating a "surveillance tech export" form of authoritarian diffusion.

**Connection to Medicine — Medical Imaging and Diagnostic AI:**
Computer vision applied to medical imaging is the area with the most validated clinical impact of any AI application. Dermatology: a 2017 Nature paper (Esteva et al.) demonstrated that a CNN trained on 129,450 skin lesion images classified skin cancer with accuracy equivalent to board-certified dermatologists. Radiology: chest X-ray AI models (CheXNet, Stanford, 2017) detect pneumonia from chest X-rays at radiologist-equivalent accuracy. Ophthalmology: DeepMind's retinal disease detection system (2018, Nature Medicine) diagnosed 54 ophthalmic conditions from retinal scans at specialist-equivalent accuracy. The clinical translation challenge: FDA clearance requires demonstration of safety and effectiveness in specific clinical populations — academic accuracy benchmarks often don't transfer to real-world clinical populations with different disease prevalences, imaging equipment, and patient demographics. By 2026, over 500 AI-enabled medical imaging devices have received FDA clearance, but systematic real-world performance monitoring infrastructure is still developing.
